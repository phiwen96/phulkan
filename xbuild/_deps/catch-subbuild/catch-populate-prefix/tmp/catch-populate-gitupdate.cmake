...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "v2.9.1"
  WORKING_DIRECTORY "/Users/pw/GitHub/phulkan/xbuild/_deps/catch-src"
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/pw/GitHub/phulkan/xbuild/_deps/catch-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/pw/GitHub/phulkan/xbuild/_deps/catch-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
